...
async def on_message(message):
    reacted = []
    print(f'Am list .... {reacted}')
    if message.author == bot.user:
        return
    print(message)
    print(f'Tis content {message.content}')
    ...
    if message.content.startswith('history'):
        ...
        print(f'Is react, adding reaction to {message}')
        reacted.append(message)
        await message.add_reaction('👍')
        print(f'Reacted message : {message}')
        print(f'Message has react? {message.reactions}')
